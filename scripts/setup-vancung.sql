-- SQL script to REFRESH the 'vancung_templates' table
-- This ensures all 7 ceremony types match the Bot's buttons exactly.

TRUNCATE TABLE public.vancung_templates;

-- Insert ALL 7 Ceremony Types with EXACT labels from bot.ts
INSERT INTO public.vancung_templates (ceremony_type, location, lyrics) VALUES
('🍱 Kỵ cơm', 'outdoor', '... (Nội dung cho Kỵ cơm) ...'),
...
('🏛️ Nhà thờ', 'outdoor', '... (Nội dung cho Nhà thờ) ...');
